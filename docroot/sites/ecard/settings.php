 ...
 *
 */
$drupal_hash_salt = 'h96OS-iilarYaNrIbjzSR9FTgX6XKRs6ea_UQ_clQms';
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/akdn/akdnecard-settings.inc');
}

/**
 * Local Development Configuration Overrides
 * Include Variable overrides for a local environment
 **/
