...
To use these stylesheets, rename the files and ak_museum with the name of your theme.
...
ak_museum-alpha-default-narrow.css  
...
ak_museum-alpha-default-normal.css
...
ak_museum-alpha-default-wide.css
