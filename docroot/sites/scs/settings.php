 ...
 *
 */
$drupal_hash_salt = 'UU3VkrOmdu34mcQIaAEbHl7IIPjbQbqTzzKh2WxUU3s';
...
/**
 * The following is configuration for Acquia's database handling AND, importantly,
 * the handling for using the shared user database. Locally, you need to comment out this entire
 * section in order for dev environments to work properly.
 */
$conf['acquia_hosting_settings_autoconnect'] = FALSE;

if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/akdn/akdnscs-settings.inc');
